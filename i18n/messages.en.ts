export default {
    ...
    home: {
        ...
        faq: {
            ...
            description: "Please check the following questions for information about our service.",
            item1: {
                title: "What is the workflow of the Cancer Classifier?",
                content: "Our Cancer Classifier processes .idat files and classifies them into one of four categories: PAAD, iCCA, Normal Bile, or No Match. The prediction workflow involves the following four steps:\n" +
                    "The classifier accepts files generated by 450k, EPIC, and EPICv2 platforms.\n" +
                    "\n" +
                    "Upload .idat Files:\n" +
                    "\n" +
                    "The classifier can handle up to 8 samples simultaneously, requiring a total of 16 files (both _Red and _Grn for each sample).\n" +
            ...
            item2: {
                title: "",
                content: "The classifier operates through two main pipelines: the pre-processing pipeline and the prediction pipeline.\n" +
                    "\n" +
                    ...
                    "Batch Effect Normalization: This is done using reCombat to adjust for any batch effects.\n" +
                    "Binomial Classifier:\n" +
                    ...
                    "PAAD / iCCA / Normal Bile Classifier:\n" +
            ...
            item3: {
                title: "Publications",
                content: "The classifier is based on the following publications:\n" +
                    "DNA methylation-based classifier differentiates intrahepatic pancreato-biliary tumours\n" +
                    "https://www.sciencedirect.com/science/article/pii/S2352396423002220"
            },
            item4: {
                title: "Who are we and why we do this?",
                content: "This website was established by Dr. Dragomir and T.G. Calina to provide access to the models published in their research. Our goal is to make these tools accessible to other researchers interested in testing them out. We believe our tool can be highly useful in specific cases and aim to simplify its usage.\n" +
                    "\n" +
