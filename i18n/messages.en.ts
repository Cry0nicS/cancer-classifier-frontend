    ...
    upload: {
        ...
        processSteps: {
            ...
            step1: {
                ...
                title: "Upload `.idat` Files",
                status: "upload-pending",
                description:
                    "For each sample, upload both Red and Grn `.idat` files.\n" +
                    "\n" +
                    "Make sure the file names follow this format: *\\_XXXXXX\\_**Red**.idat and *\\_XXXXXX\\_**Grn**.idat.\n" +
                    "(E.g. NAME_206702460068_R03C01_Red.idat)\n" +
                    "\n" +
                    "Ensure your `.idat` files are generated by the `450k`, `EPIC`, or `EPICv2` arrays."
            },
            step2: {
                order: "2",
                icon: "iconamoon:number-2-bold",
                title: "Specify Sample Storage Type",
                status: "upload-finished",
                description:
                    "Indicate whether your samples were stored in FFPE or Fresh Frozen.\n" +
                    "\n" +
                    "This step is crucial as the storage type significantly affects DNA methylation data, impacting the accuracy of the model."
            },
            step3: {
                order: "3",
                ...
                description:
                    "The process reads `.idat` files, extracts beta values, and normalizes them using FunNorm and BMIQ.\n" +
                    "\n" +
                    "The analysis takes up to 5 minutes. Please be patient during this time."
            },
            step4: {
                order: "4",
                ...
                description:
                    "From the normalized beta values, the relevant CpGs are extracted and the prediction algorithm is applies.\n" +
                    "\n" +
                    "The analysis takes up to 5 minutes. Please be patient during this time."
            },
            step5: {
                ...
                description:
                    "Once the analysis is complete, you will be redirected to the results page.\n" +
                    "You will receive the prediction label along with the probability scores for each class.\n" +
                    "\n" +
                    "This detailed output helps in understanding the confidence of the classifier in its predictions.\n"
            }
        }
    },
    // -- Dashboard
